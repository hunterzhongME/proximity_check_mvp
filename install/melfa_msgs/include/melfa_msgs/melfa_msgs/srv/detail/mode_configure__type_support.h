...
#ifndef MELFA_MSGS__SRV__DETAIL__MODE_CONFIGURE__TYPE_SUPPORT_H_
#define MELFA_MSGS__SRV__DETAIL__MODE_CONFIGURE__TYPE_SUPPORT_H_
...
#endif  // MELFA_MSGS__SRV__DETAIL__MODE_CONFIGURE__TYPE_SUPPORT_H_
