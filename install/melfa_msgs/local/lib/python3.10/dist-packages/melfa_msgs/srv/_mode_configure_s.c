...
bool melfa_msgs__srv__mode_configure__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("melfa_msgs.srv._mode_configure.ModeConfigure_Request", full_classname_dest, 52) == 0);
  }
  melfa_msgs__srv__ModeConfigure_Request * ros_message = _ros_message;
  {  // hand_io_interface
...
PyObject * melfa_msgs__srv__mode_configure__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("melfa_msgs.srv._mode_configure");
...
ROSIDL_GENERATOR_C_EXPORT
bool melfa_msgs__srv__mode_configure__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("melfa_msgs.srv._mode_configure.ModeConfigure_Response", full_classname_dest, 53) == 0);
  }
  melfa_msgs__srv__ModeConfigure_Response * ros_message = _ros_message;
  {  // success
