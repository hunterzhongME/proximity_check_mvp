...
bool melfa_mon_msgs__srv__mode_configure__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("melfa_mon_msgs.srv._mode_configure.ModeConfigure_Request", full_classname_dest, 56) == 0);
  }
  melfa_mon_msgs__srv__ModeConfigure_Request * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of ModeConfigure_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("melfa_mon_msgs.srv._mode_configure");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModeConfigure_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool melfa_mon_msgs__srv__mode_configure__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("melfa_mon_msgs.srv._mode_configure.ModeConfigure_Response", full_classname_dest, 57) == 0);
  }
  melfa_mon_msgs__srv__ModeConfigure_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of ModeConfigure_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("melfa_mon_msgs.srv._mode_configure");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModeConfigure_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
