...
class Metaclass_ModeConfigure(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'melfa_mon_msgs.srv.ModeConfigure')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from melfa_mon_msgs.srv import _mode_configure
...
class ModeConfigure(metaclass=Metaclass_ModeConfigure):
    from melfa_mon_msgs.srv._mode_configure import ModeConfigure_Request as Request
    from melfa_mon_msgs.srv._mode_configure import ModeConfigure_Response as Response
