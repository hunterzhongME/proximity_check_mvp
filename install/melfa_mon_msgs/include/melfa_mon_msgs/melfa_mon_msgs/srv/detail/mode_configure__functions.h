...
#ifndef MELFA_MON_MSGS__SRV__DETAIL__MODE_CONFIGURE__FUNCTIONS_H_
#define MELFA_MON_MSGS__SRV__DETAIL__MODE_CONFIGURE__FUNCTIONS_H_
 ...
 * calls
 * melfa_mon_msgs__srv__ModeConfigure_Request__init().
...
/**
 * It calls
 * melfa_mon_msgs__srv__ModeConfigure_Request__fini()
 ...
 * melfa_mon_msgs__srv__ModeConfigure_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * melfa_mon_msgs__srv__ModeConfigure_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * melfa_mon_msgs__srv__ModeConfigure_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_melfa_mon_msgs
...
/**
 * It calls
 * melfa_mon_msgs__srv__ModeConfigure_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_melfa_mon_msgs
...
/**
 * It allocates the memory for the array and calls
 * melfa_mon_msgs__srv__ModeConfigure_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_melfa_mon_msgs
...
/**
 * It calls
 * melfa_mon_msgs__srv__ModeConfigure_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MELFA_MON_MSGS__SRV__DETAIL__MODE_CONFIGURE__FUNCTIONS_H_
