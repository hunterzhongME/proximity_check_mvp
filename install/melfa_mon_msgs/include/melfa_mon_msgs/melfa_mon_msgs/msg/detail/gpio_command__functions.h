...
#ifndef MELFA_MON_MSGS__MSG__DETAIL__GPIO_COMMAND__FUNCTIONS_H_
#define MELFA_MON_MSGS__MSG__DETAIL__GPIO_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * melfa_mon_msgs__msg__GpioCommand__init().
...
/**
 * It calls
 * melfa_mon_msgs__msg__GpioCommand__fini()
 ...
 * melfa_mon_msgs__msg__GpioCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * melfa_mon_msgs__msg__GpioCommand__Sequence__fini()
 * on the array,
...
#endif  // MELFA_MON_MSGS__MSG__DETAIL__GPIO_COMMAND__FUNCTIONS_H_
